<!-- Source of the published repository's README, copied by ../scripts/deploy-landing.sh.
     IT IS A POINTER, AND STAYS ONE. The page at the URL below owns every claim about the work, so
     nothing is restated here: one statement of the science, in one place, cannot fall out of step
